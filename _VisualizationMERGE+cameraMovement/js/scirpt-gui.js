...
function GUI_basic() {
    let GUI_basicFolder = gui.addFolder("GUI_BASIC");
    // GUI_basicFolder.open();
    GUI_basicFolder.add(params_basic, "Particles_in_scene").listen();
    GUI_basicFolder.add(params_basic, "PARTICLE_NUMBER", 0, 10000, 1);
    GUI_basicFolder.add(params_basic, "WORLD_WIDTH", 0, 2000, 1);
    GUI_basicFolder.add(params_basic, "WORLD_HEIGHT", 0, 2000, 1);
    GUI_basicFolder.add(params_basic, "WORLD_DEPTH", 0, 2000, 1);
    GUI_basicFolder.add(params_basic, "cameraX", -1000, 1000, 1).listen();
    GUI_basicFolder.add(params_basic, "cameraY", -1000, 1000, 1).listen();
    GUI_basicFolder.add(params_basic, "cameraZ", 1000, 1000, 1).listen();
    GUI_basicFolder.add(params_basic, "cameraLookAtX", -500, 500, 1).listen();
    GUI_basicFolder.add(params_basic, "cameraLookAtY", -500, 500, 1).listen();
    GUI_basicFolder.add(params_basic, "cameraLookAtZ", -500, 500, 1).listen();
