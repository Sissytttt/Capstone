...
class Group {
  ...
  set_lines() {
    ...
    for (let i = 0; i < this.num; i++) {
      ...
      let endPos = createVector(posEndX, posEndY, posEndZ);
      let newLine = new Line()
        .set_startPos(this.pos.x, this.pos.y, this.pos.z)
        .set_endPos(posEndX, posEndY);
...
class Line {
  ...
  addNewParticle() {
    ...
    let noiseValue = noise(yFreq, p_posX)
    let noiseBrightness;
    if (noiseValue < 0.2) {
