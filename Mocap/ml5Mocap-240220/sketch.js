...
// ------------------- Notes ----------------------
// ------- Problem -------
// 1. calculated values are too fluctuated
//  Revised in the next iteration: 
//    1. using only upper body parts to do the calculation (lower body are not accurate)
//    2. filter with the confidence value (confidence > 0.75)
//    3. use average value instead of sum
// 2. z value is not obvious -- (-1, 1)?

// ------- TODO -------
// 1. visualize flow
// 2. smooth the data with lerp
