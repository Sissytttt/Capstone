...
// ------------------- Notes ----------------------
// ------- Changes -------
// 1. Revised a bit of the fluctuation problem
//    using upper body data, confidence score filtering, average value

// ------- Problem -------
// 1. The space visualization is not working well, not sure why, but it is worse than the previous version
...
let prev_poses = [];
let keypoints = {};
let keypoints = { "left_hip": null, "right_hip": null, "right_shoulder": null, "left_shoulder": null, "torso": null, "right_foot_index": null, "left_foot_index": null };
...
function setup() {
  ...
  for (const bodypart in keypoints) {
    keypoints[bodypart] = new SimpleNode(bodypart);
  }
